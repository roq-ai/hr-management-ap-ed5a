  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to HR Management Application - where advanced redux, createAsyncThunk, and createSlice concepts streamline your Human Resource operations for a more efficient business."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to HR Management Application - where advanced redux, createAsyncThunk, and createSlice concepts streamline your Human Resource operations for a more efficient business.`}
            </Text>
            <Box
